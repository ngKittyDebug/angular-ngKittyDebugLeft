...
import { applyBumpDamage } from '../core/apply-bumps';
import type { BumpDamage } from '../core/tick/separate-players';
...
describe('applyBumpDamage', () => {
  it('is a no-op for an empty bump list', () => {
    ...
    const result = applyBumpDamage(FRENZY_DEFINITION, state, []);
