...
// `bomb`, `vitamin`, `shield`, `cactus`, `easterEgg` and `poop` are never "eaten" (bomb explodes; the others grant
// effects), so their counts stay 0 and the fainted breakdown skips them.
