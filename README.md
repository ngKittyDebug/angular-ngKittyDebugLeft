...
**PokeDex** — учебное Angular 22 приложение вокруг открытого PokeAPI: каталог из 1300+ покемонов с фильтрами по типам и поколениям, пагинацией и детальными страницами, дополненный авторизацией, профилем тренера, тёмной/светлой темой и интернационализацией (ru/en). Помимо обязательного каталога команда реализовала несколько игр: пошаговую битву покемонов, тамагочи-питомца и реалтайм-аркаду Frenzy на PartyKit (WebSocket). Приложение построено на современном стеке — сигналы, @ngrx/signals, standalone-компоненты со стратегией OnPush, Taiga UI v5 и Transloco — и покрыто тестами на Vitest. Главная цель проекта — на практике освоить новейшие возможности Angular, не ограничиваясь минимальными требованиями задания.
